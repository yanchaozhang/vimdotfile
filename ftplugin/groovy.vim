...
if !hasmapto("<SID>RunPrompt()", "n")
	nmap <buffer><unique><silent> <leader>grp :call <SID>RunPrompt()<CR>
endif
if !hasmapto("<SID>RunNoPrompt()")
	nmap <buffer><unique><silent> <leader>rr :call <SID>RunNoPrompt()<CR>
endif
if !hasmapto("<SID>CompilePrompt()")
	nmap <buffer><unique><silent> <leader>gcp :call <SID>CompilePrompt()<CR>
endif
if !hasmapto("<SID>CompileNoPrompt()")
	nmap <buffer><unique><silent> <leader>gcnp :call <SID>CompileNoPrompt()<CR>
endif
