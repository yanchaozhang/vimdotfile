" Changed the color of not-inserted text (i.e. end of file crap)
" to black, so it doesn't look effed up.
...
let g:colors_name = "Dim_Nate"

hi Normal guibg=black guifg=grey75
hi Cursor guibg=grey75
hi NonText guibg=black guifg=grey75
" Addded by Nate
