...
" Change fuzzy finder's g:homedir or whatever to current dir.
nmenu Helpful.Fuzzy.Change\ Dir<Tab><leader>ncd <leader>ncd<CR>
nmenu Helpful.Fuzzy.Edit\ Favorites :FuzzyFinderEditInfo<CR>
nmenu Helpful.Fuzzy.Recent\ Files<Tab><F7> :FuzzyFinderMruFile<CR>
nmenu Helpful.Fuzzy.Reload :FuzzyFinderRemoveCache<CR>
